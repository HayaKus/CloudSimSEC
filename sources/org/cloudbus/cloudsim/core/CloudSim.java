...
public class CloudSim {
	...
	public static double startSimulation() throws NullPointerException {
		...
		try {
			...
			return clock;
		} catch (IllegalArgumentException | MWException e) {
			e.printStackTrace();
	 ...
	 * @return true, if successful otherwise
	 */
	public static boolean runClockTick() throws MWException {
		SimEntity ent;
		boolean queue_empty;
	 ...
	 */
	public static double run() throws MWException {
		if (!running) {
			runStart();
		}
		while (true) {
	 ...
	 * in user simulations.
	 */
	public static void finishSimulation() throws MWException {
