...
public class HostDynamicWorkload extends Host {
	...
	/** This is used to store the temp hostload's number of host. */
	private static double tempHostLoad;
	...
	public double updateVmsProcessing(double currentTime) {
		...
		//Addition:
		if (!Log.isDisabled()) {
			Log.formatLine("Addition:The hostload of [Host #" + getId() + "] is "+getHostLoad()+".");
		}
		...
		// store the hostload into tempHostLoad
		tempHostLoad = getHostLoad();
	...
	public
			void
			addStateHistoryEntry(double time, double allocatedMips, double requestedMips, int hostload, boolean isActive) {
	...
	public static double getTempHostLoad() {
		return tempHostLoad;
	}
}
