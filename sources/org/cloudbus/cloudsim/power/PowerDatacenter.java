...
public class PowerDatacenter extends Datacenter {
	 ...
	 */
	@Override
	protected void updateCloudletProcessing() throws MWException {
	 ...
	 * @return the double
	 */
	protected double updateCloudetProcessingWithoutSchedulingFutureEvents() throws MWException {
	 ...
	 * @return the double
	 */
	protected double updateCloudetProcessingWithoutSchedulingFutureEventsForce() throws MWException {
		double currentTime = CloudSim.clock();
	 ...
	 */
	@Override
	protected void processVmMigrate(SimEvent ev, boolean ack) throws MWException {
	 ...
	 */
	@Override
	protected void processCloudletSubmit(SimEvent ev, boolean ack) throws MWException {
