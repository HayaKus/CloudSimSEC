...
public abstract class RamProvisioner {
	...
	public RamProvisioner(int ram) {
		...
		//Addition:
		setRamUsage((double)0);
	}
	
	//Addition:setRamUsage
	public void setRamUsage(double i) {
		this.ramUsage = i;
	}
	
	//Addition:updateRamUsage
	public void updateRamUsage() {
		this.ramUsage = 1 - (availableRam/ram);
	}
