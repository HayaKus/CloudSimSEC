...
public class HostStateHistoryEntry {
	 ...
	 */
	public HostStateHistoryEntry(double time, double allocatedMips, double requestedMips, int hostload, boolean isActive) {
		setTime(time);
		setAllocatedMips(allocatedMips);
		setRequestedMips(requestedMips);
		setHostLoad(hostload);
		setActive(isActive);
	}

	/**
	 * Sets the load of host.
	 * 
	 * @param hostload the new load of host
	 */
	private void setHostLoad(int hostload2) {
		// TODO Auto-generated method stub
		this.hostload = hostload2;
	}
	
	/**
	 * Gets the load of host.
	 * 
	 * @return the hostload
	 */
